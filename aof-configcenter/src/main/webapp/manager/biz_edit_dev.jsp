...
function save(btn,fileName){
	$.ajax({
		   type: "POST",
		   url: "../manager/biz_edit_dev_save/"+fileName,
		   dataType:"json",
...
function checkFile(fileName,btn){
	$.ajax({
		   type: "POST",
		   url: "../manager/edit_dev_check_biz_file",
		   dataType:"json",
...
$(document).ready(function(){
	...
	$.ajax({
		   type: "POST",
		   url: "../manager/biz_edit_dev",
		   dataType:"json",
		   data:{fileName:"<%=fileName%>"} ,
		   success: function(msg){
		     if(msg.code==0){
		    	 paresJson2Biz(msg.result,"<%=defaultName%>");
		     }else{
		    	alert(msg.msg);
		     }
		   }
	...
	<%}else{%>
	paresJson2Biz(null,"<%=defaultName%>");
	<%}%>
...
<div class="container" style="margin-left:30px;margin-right:30px;">
    <div class="row">
         <div class="col-xs-3" id="myScrollspy" style="display:none">
